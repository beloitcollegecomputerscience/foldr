 ...
 * 
 */
public class TestGUI extends JFrame implements ActionListener, MouseListener, MouseMotionListener {
	...
	public void createJRViewers() {
		...
		Shape shapeOne = new Shape(3, scene);
		Shape shapeTwo = new Shape(4, scene);
		Shape shapeFour = new Shape(6, scene);
	...
	private static TestGUI theProgram;
	public static void main(String[] args) {
		theProgram = new TestGUI();
